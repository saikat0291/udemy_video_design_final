class ContactUsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @contact_u.save
        format.html { redirect_to @contact_u, notice: 'Form was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @contact_u.update(contact_u_params)
        format.html { redirect_to @contact_u, notice: 'Form was successfully updated.' }
  ...
  def destroy
    @contact_u.destroy
    respond_to do |format|
      format.html { redirect_to contact_us_url, notice: 'Form was successfully destroyed.' }
